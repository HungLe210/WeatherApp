...
public class WeatherApp {
    //fetch weather app data for given location
            public static JSONObject getWeatherData(String locationName){
                ...
                try{
                    ...
                    //I want to get the current hour's data
                    //So I need to get the index of our current hour
        ...
        private static int findIndexOfCurrentTime(JSONArray timeList){
                ...
                // iterate through the time list and see which one mathces our current time
